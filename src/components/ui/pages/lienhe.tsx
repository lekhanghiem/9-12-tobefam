                          ...
                          <TextField
                            sx={{
                              ...
                              '& .MuiOutlinedInput-root':
                                {
                                  height:
                                    '100%',
                                  borderRadius:
                                    '20px', // Bo góc của viền
                                  '& fieldset':
                                    {
                                      border:
                                        '2px solid #007E94', // Màu viền mặc định
                                      borderRadius:
                                        '20px'
                                    }
                                },
                              ...
                              '& .MuiInputLabel-root':
                                {
                                  color:
                                    '#f8fbfc' // Màu của label khi không focus
                                }
                            }}
                            ...
                            <Button
                              ...
                              sx={{
                                ...
                                '&:hover':
                                  {
                                    backgroundColor:
                                      '#007E94', // Darker blue on hover
                                    border:
                                      '2px solid #007E94' // Add border on hover
                                  },
                                '&:active':
                                  {
                                    backgroundColor:
                                      '#007E94' // Darker blue when active
                                  }
                              }}
                            >
                              Xác
